...
ptu_interfaces__action__SetPanTilt_Goal__create()
{
  ...
  ptu_interfaces__action__SetPanTilt_Goal * msg = (ptu_interfaces__action__SetPanTilt_Goal *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ptu_interfaces__action__SetPanTilt_Goal));
  bool success = ptu_interfaces__action__SetPanTilt_Goal__init(msg);
  if (!success) {
...
ptu_interfaces__action__SetPanTilt_Goal__destroy(ptu_interfaces__action__SetPanTilt_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ptu_interfaces__action__SetPanTilt_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_Goal__Sequence__init(ptu_interfaces__action__SetPanTilt_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_Goal * data = NULL;

  if (size) {
    data = (ptu_interfaces__action__SetPanTilt_Goal *)allocator.zero_allocate(size, sizeof(ptu_interfaces__action__SetPanTilt_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ptu_interfaces__action__SetPanTilt_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ptu_interfaces__action__SetPanTilt_Goal__fini(&data[i - 1]);
      }
...
ptu_interfaces__action__SetPanTilt_Goal__Sequence__fini(ptu_interfaces__action__SetPanTilt_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ptu_interfaces__action__SetPanTilt_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_Goal__Sequence * array = (ptu_interfaces__action__SetPanTilt_Goal__Sequence *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ptu_interfaces__action__SetPanTilt_Goal__Sequence__init(array, size);
  if (!success) {
...
ptu_interfaces__action__SetPanTilt_Goal__Sequence__destroy(ptu_interfaces__action__SetPanTilt_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ptu_interfaces__action__SetPanTilt_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_Goal__Sequence__are_equal(const ptu_interfaces__action__SetPanTilt_Goal__Sequence * lhs, const ptu_interfaces__action__SetPanTilt_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ptu_interfaces__action__SetPanTilt_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ptu_interfaces__action__SetPanTilt_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ptu_interfaces__action__SetPanTilt_Goal * data =
      (ptu_interfaces__action__SetPanTilt_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ptu_interfaces__action__SetPanTilt_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ptu_interfaces__action__SetPanTilt_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_Result * msg = (ptu_interfaces__action__SetPanTilt_Result *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ptu_interfaces__action__SetPanTilt_Result));
  bool success = ptu_interfaces__action__SetPanTilt_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_Result__destroy(ptu_interfaces__action__SetPanTilt_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ptu_interfaces__action__SetPanTilt_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_Result__Sequence__init(ptu_interfaces__action__SetPanTilt_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_Result * data = NULL;

  if (size) {
    data = (ptu_interfaces__action__SetPanTilt_Result *)allocator.zero_allocate(size, sizeof(ptu_interfaces__action__SetPanTilt_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ptu_interfaces__action__SetPanTilt_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ptu_interfaces__action__SetPanTilt_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_Result__Sequence__fini(ptu_interfaces__action__SetPanTilt_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ptu_interfaces__action__SetPanTilt_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_Result__Sequence * array = (ptu_interfaces__action__SetPanTilt_Result__Sequence *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ptu_interfaces__action__SetPanTilt_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_Result__Sequence__destroy(ptu_interfaces__action__SetPanTilt_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ptu_interfaces__action__SetPanTilt_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_Result__Sequence__are_equal(const ptu_interfaces__action__SetPanTilt_Result__Sequence * lhs, const ptu_interfaces__action__SetPanTilt_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ptu_interfaces__action__SetPanTilt_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ptu_interfaces__action__SetPanTilt_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ptu_interfaces__action__SetPanTilt_Result * data =
      (ptu_interfaces__action__SetPanTilt_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ptu_interfaces__action__SetPanTilt_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ptu_interfaces__action__SetPanTilt_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_Feedback__init(ptu_interfaces__action__SetPanTilt_Feedback * msg)
{
  ...
  // percentage_of_completing_pan
  // percentage_of_completing_tilt
  return true;
}
...
ptu_interfaces__action__SetPanTilt_Feedback__are_equal(const ptu_interfaces__action__SetPanTilt_Feedback * lhs, const ptu_interfaces__action__SetPanTilt_Feedback * rhs)
{
  ...
  // percentage_of_completing_pan
  if (lhs->percentage_of_completing_pan != rhs->percentage_of_completing_pan) {
    return false;
  }
  // percentage_of_completing_tilt
  if (lhs->percentage_of_completing_tilt != rhs->percentage_of_completing_tilt) {
    return false;
  }
  return true;
}
  ...
  ptu_interfaces__action__SetPanTilt_Feedback * output)
{
  ...
  // percentage_of_completing_pan
  output->percentage_of_completing_pan = input->percentage_of_completing_pan;
  // percentage_of_completing_tilt
  output->percentage_of_completing_tilt = input->percentage_of_completing_tilt;
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_Feedback * msg = (ptu_interfaces__action__SetPanTilt_Feedback *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ptu_interfaces__action__SetPanTilt_Feedback));
  bool success = ptu_interfaces__action__SetPanTilt_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_Feedback__destroy(ptu_interfaces__action__SetPanTilt_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ptu_interfaces__action__SetPanTilt_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_Feedback__Sequence__init(ptu_interfaces__action__SetPanTilt_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_Feedback * data = NULL;

  if (size) {
    data = (ptu_interfaces__action__SetPanTilt_Feedback *)allocator.zero_allocate(size, sizeof(ptu_interfaces__action__SetPanTilt_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ptu_interfaces__action__SetPanTilt_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ptu_interfaces__action__SetPanTilt_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_Feedback__Sequence__fini(ptu_interfaces__action__SetPanTilt_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ptu_interfaces__action__SetPanTilt_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_Feedback__Sequence * array = (ptu_interfaces__action__SetPanTilt_Feedback__Sequence *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ptu_interfaces__action__SetPanTilt_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_Feedback__Sequence__destroy(ptu_interfaces__action__SetPanTilt_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ptu_interfaces__action__SetPanTilt_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_Feedback__Sequence__are_equal(const ptu_interfaces__action__SetPanTilt_Feedback__Sequence * lhs, const ptu_interfaces__action__SetPanTilt_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ptu_interfaces__action__SetPanTilt_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ptu_interfaces__action__SetPanTilt_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ptu_interfaces__action__SetPanTilt_Feedback * data =
      (ptu_interfaces__action__SetPanTilt_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ptu_interfaces__action__SetPanTilt_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ptu_interfaces__action__SetPanTilt_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_SendGoal_Request__init(ptu_interfaces__action__SetPanTilt_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ptu_interfaces__action__SetPanTilt_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!ptu_interfaces__action__SetPanTilt_Goal__init(&msg->goal)) {
    ptu_interfaces__action__SetPanTilt_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
ptu_interfaces__action__SetPanTilt_SendGoal_Request__fini(ptu_interfaces__action__SetPanTilt_SendGoal_Request * msg)
{
  ...
  // goal
  ptu_interfaces__action__SetPanTilt_Goal__fini(&msg->goal);
}
...
ptu_interfaces__action__SetPanTilt_SendGoal_Request__are_equal(const ptu_interfaces__action__SetPanTilt_SendGoal_Request * lhs, const ptu_interfaces__action__SetPanTilt_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!ptu_interfaces__action__SetPanTilt_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_SendGoal_Request * msg = (ptu_interfaces__action__SetPanTilt_SendGoal_Request *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Request));
  bool success = ptu_interfaces__action__SetPanTilt_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence__init(ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_SendGoal_Request * data = NULL;

  if (size) {
    data = (ptu_interfaces__action__SetPanTilt_SendGoal_Request *)allocator.zero_allocate(size, sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ptu_interfaces__action__SetPanTilt_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ptu_interfaces__action__SetPanTilt_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence__fini(ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ptu_interfaces__action__SetPanTilt_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence * array = (ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence__destroy(ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence__are_equal(const ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence * lhs, const ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ptu_interfaces__action__SetPanTilt_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ptu_interfaces__action__SetPanTilt_SendGoal_Request * data =
      (ptu_interfaces__action__SetPanTilt_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ptu_interfaces__action__SetPanTilt_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ptu_interfaces__action__SetPanTilt_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_SendGoal_Response__init(ptu_interfaces__action__SetPanTilt_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    ptu_interfaces__action__SetPanTilt_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_SendGoal_Response * msg = (ptu_interfaces__action__SetPanTilt_SendGoal_Response *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Response));
  bool success = ptu_interfaces__action__SetPanTilt_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence__init(ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_SendGoal_Response * data = NULL;

  if (size) {
    data = (ptu_interfaces__action__SetPanTilt_SendGoal_Response *)allocator.zero_allocate(size, sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ptu_interfaces__action__SetPanTilt_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ptu_interfaces__action__SetPanTilt_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence__fini(ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ptu_interfaces__action__SetPanTilt_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence * array = (ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence__destroy(ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence__are_equal(const ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence * lhs, const ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ptu_interfaces__action__SetPanTilt_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ptu_interfaces__action__SetPanTilt_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ptu_interfaces__action__SetPanTilt_SendGoal_Response * data =
      (ptu_interfaces__action__SetPanTilt_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ptu_interfaces__action__SetPanTilt_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ptu_interfaces__action__SetPanTilt_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_GetResult_Request__init(ptu_interfaces__action__SetPanTilt_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ptu_interfaces__action__SetPanTilt_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_GetResult_Request * msg = (ptu_interfaces__action__SetPanTilt_GetResult_Request *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Request));
  bool success = ptu_interfaces__action__SetPanTilt_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence__init(ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_GetResult_Request * data = NULL;

  if (size) {
    data = (ptu_interfaces__action__SetPanTilt_GetResult_Request *)allocator.zero_allocate(size, sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ptu_interfaces__action__SetPanTilt_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ptu_interfaces__action__SetPanTilt_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence__fini(ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ptu_interfaces__action__SetPanTilt_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence * array = (ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence__destroy(ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence__are_equal(const ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence * lhs, const ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ptu_interfaces__action__SetPanTilt_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ptu_interfaces__action__SetPanTilt_GetResult_Request * data =
      (ptu_interfaces__action__SetPanTilt_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ptu_interfaces__action__SetPanTilt_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ptu_interfaces__action__SetPanTilt_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_GetResult_Response__init(ptu_interfaces__action__SetPanTilt_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!ptu_interfaces__action__SetPanTilt_Result__init(&msg->result)) {
    ptu_interfaces__action__SetPanTilt_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
ptu_interfaces__action__SetPanTilt_GetResult_Response__fini(ptu_interfaces__action__SetPanTilt_GetResult_Response * msg)
{
  ...
  // status
  // result
  ptu_interfaces__action__SetPanTilt_Result__fini(&msg->result);
}
...
ptu_interfaces__action__SetPanTilt_GetResult_Response__are_equal(const ptu_interfaces__action__SetPanTilt_GetResult_Response * lhs, const ptu_interfaces__action__SetPanTilt_GetResult_Response * rhs)
{
  ...
  // result
  if (!ptu_interfaces__action__SetPanTilt_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_GetResult_Response * msg = (ptu_interfaces__action__SetPanTilt_GetResult_Response *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Response));
  bool success = ptu_interfaces__action__SetPanTilt_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence__init(ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_GetResult_Response * data = NULL;

  if (size) {
    data = (ptu_interfaces__action__SetPanTilt_GetResult_Response *)allocator.zero_allocate(size, sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ptu_interfaces__action__SetPanTilt_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ptu_interfaces__action__SetPanTilt_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence__fini(ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ptu_interfaces__action__SetPanTilt_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence * array = (ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence__destroy(ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence__are_equal(const ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence * lhs, const ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ptu_interfaces__action__SetPanTilt_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ptu_interfaces__action__SetPanTilt_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ptu_interfaces__action__SetPanTilt_GetResult_Response * data =
      (ptu_interfaces__action__SetPanTilt_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ptu_interfaces__action__SetPanTilt_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ptu_interfaces__action__SetPanTilt_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_FeedbackMessage__init(ptu_interfaces__action__SetPanTilt_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ptu_interfaces__action__SetPanTilt_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!ptu_interfaces__action__SetPanTilt_Feedback__init(&msg->feedback)) {
    ptu_interfaces__action__SetPanTilt_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
ptu_interfaces__action__SetPanTilt_FeedbackMessage__fini(ptu_interfaces__action__SetPanTilt_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  ptu_interfaces__action__SetPanTilt_Feedback__fini(&msg->feedback);
}
...
ptu_interfaces__action__SetPanTilt_FeedbackMessage__are_equal(const ptu_interfaces__action__SetPanTilt_FeedbackMessage * lhs, const ptu_interfaces__action__SetPanTilt_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!ptu_interfaces__action__SetPanTilt_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_FeedbackMessage * msg = (ptu_interfaces__action__SetPanTilt_FeedbackMessage *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ptu_interfaces__action__SetPanTilt_FeedbackMessage));
  bool success = ptu_interfaces__action__SetPanTilt_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence__init(ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_FeedbackMessage * data = NULL;

  if (size) {
    data = (ptu_interfaces__action__SetPanTilt_FeedbackMessage *)allocator.zero_allocate(size, sizeof(ptu_interfaces__action__SetPanTilt_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ptu_interfaces__action__SetPanTilt_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ptu_interfaces__action__SetPanTilt_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence__fini(ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ptu_interfaces__action__SetPanTilt_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence * array = (ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence *)allocator.allocate(sizeof(ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence__destroy(ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence__are_equal(const ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence * lhs, const ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ptu_interfaces__action__SetPanTilt_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ptu_interfaces__action__SetPanTilt_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ptu_interfaces__action__SetPanTilt_FeedbackMessage * data =
      (ptu_interfaces__action__SetPanTilt_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ptu_interfaces__action__SetPanTilt_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ptu_interfaces__action__SetPanTilt_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ptu_interfaces__action__SetPanTilt_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
