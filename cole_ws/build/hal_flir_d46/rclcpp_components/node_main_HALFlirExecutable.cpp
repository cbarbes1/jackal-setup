...
#define NODE_MAIN_LOGGER_NAME "HALFlirExecutable"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhal_flir_d46.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<hal::FlirD46>";
